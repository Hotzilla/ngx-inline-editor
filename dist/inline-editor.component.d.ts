...
import { InlineEditorEvent, Events } from "./types/inline-editor-events.class";
...
export declare class InlineEditorComponent implements OnInit, AfterContentInit, OnDestroy, ControlValueAccessor {
    ...
    save({event, state: hotState}: InlineEditorEvent): void;
    saveAndClose(outsideEvent: InlineEditorEvent): void;
    cancel(outsideEvent: InlineEditorEvent): void;
