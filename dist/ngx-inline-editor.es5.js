...
var InlineEditorState = (function () {
    ...
    function InlineEditorState(_a) {
        var _b = _a === void 0 ? { value: "", name: "" } : _a, value = _b.value, _c = _b.disabled, disabled = _c === void 0 ? false : _c, _d = _b.editing, editing = _d === void 0 ? false : _d, _e = _b.empty, empty = _e === void 0 ? false : _e, name = _b.name;
        this.value = value;
...
var InputBase = (function () {
    ...
    InputBase.prototype.checkValue = function () {
        ...
        if (this.canTestLength(this.config)) {
            ...
            var /** @type {?} */ length_1 = this.isNumeric ? Number(value) : value.length;
            if (length_1 < min || length_1 > max) {
                errs.push({
                    type: "LENGTH_ERROR",
...
export { InlineEditorModule, InlineEditorComponent, InputTextComponent, InputDateComponent, InputDatetimeComponent, InputNumberComponent, InputRangeComponent, InputPasswordComponent, InputSelectComponent, InputTextareaComponent, InputTimeComponent, InputBase };
